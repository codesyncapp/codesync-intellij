...
public class StagingConfiguration implements Configuration {
    private static StagingConfiguration configuration = null;

    public String CODESYNC_DIR_NAME = ".codesync-staging-intellij";
    public String CODESYNC_DOMAIN = "api-staging.codesync.com";
    public String CODESYNC_HOST = "https://api-staging.codesync.com";
    public String CODESYNC_WEBSOCKET = String.format("ws://%s/v2/websocket", CODESYNC_DOMAIN);
    public String CODESYNC_APP = "https://staging.codesync.com";
    public String WEB_APP_URL = "https://staging.codesync.com";
    ...
    public static StagingConfiguration getInstance () {
        if (configuration == null) {
            configuration = new StagingConfiguration();
        }
