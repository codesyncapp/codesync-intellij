...
public final class Constants {
    ...
    public static final class Notification {
        ...
        public static String REPO_SYNC_IN_PROGRESS_MESSAGE = "Repo is being synced with CodeSync.";
        public static String REPO_IN_SYNC_MESSAGE = "Repo is synced with CodeSync.";
