...
public final class Constants {
    ...
    public static String WEBSOCKET_ENDPOINT = String.format("wss://%s/v2/websocket", CODESYNC_DOMAIN);
    ...
    public static final class Notification {
        ...
        public static String BRANCH_INIT_SUCCESS_MESSAGE = "Branch '%s' initialized successfully, your new branch will now be synced with CodeSync.";
        public static String BRANCH_INIT_ERROR_MESSAGE = "Branch '%s' initialization errored out, please try again later. If problem persists then contact support.";
        public static String BRANCH_INIT_FAILURE_MESSAGE = "Branch '%s' could not be initialized successfully, please try again later. If problem persists then contact support.";
